...
const VALUES = [
  {
    icon: "🎯",
    title: "Quality First",
    desc: "We never ship mediocre code. Every line is reviewed, tested, and refined.",
  },
  {
    icon: "🚀",
    title: "Speed & Scale",
    desc: "Built for the long run. Our architectures handle 10x growth effortlessly.",
  },
  {
    icon: "🤝",
    title: "Transparency",
    desc: "Real-time project dashboards. No surprises, ever.",
  },
  {
    icon: "🌱",
    title: "Continuous Learning",
    desc: "We adopt emerging tech early and transfer that knowledge to you.",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-24">
          {VALUES.map((v) => (
            <div
              key={v.title}
              className="glass rounded-2xl p-8 flex gap-5 hover:border-brand-500/40 transition-all"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {TEAM.map((m) => (
            <div
              key={m.name}
              className="glass rounded-2xl p-6 text-center hover:border-brand-500/40 hover:-translate-y-1 transition-all duration-300"
            >
              ...
              <p className="text-brand-400 text-xs font-medium mb-1">
                {m.role}
              </p>
