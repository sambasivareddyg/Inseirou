  ...
  return (
    <div>
      ...
      <main role="main">
        ...
        <div className="container">
          <nav className="my-3 ms-3" style="--bs-breadcrumb-divider: '>';">
          ...
          <div className="row ">
            <div className="col-6 col-lg-8">
              <img src={applepie} className="img-fluid rounded-1">
                {" "}
              </img>
            </div>
        ...
        >
          ...
          <div className="offcanvas-body">
            ...
            <a type="button" href="order.html" className="m-1 btn btn-success">
              Go to order page
            </a>
